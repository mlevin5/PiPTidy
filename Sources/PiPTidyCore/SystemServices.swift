...
public final class SystemAXService: AXInventoryProviding, WindowMutating, @unchecked Sendable {
    ...
    public func setFrame(id: String, frame: CGRect) throws {
        ...
        // then resize and repeat the position because browsers may move PiP while
        // enforcing their aspect ratio.
        for (name, value) in [(kAXPositionAttribute as CFString, position), (kAXSizeAttribute as CFString, sizeValue), (kAXPositionAttribute as CFString, position)] {
